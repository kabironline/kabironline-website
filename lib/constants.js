...
import { SiGo, SiGooglegemini, SiVuedotjs, SiTypescript } from "react-icons/si";
...
export const experience = {
  ...
  items: [
    {
      company: "IFAD - IOE",
      position: "Data Scientist (AI) Intern",
      duration: "Sept 2024 - Present",
    },
    {
      company: "ManiarTech",
      position: "ML Researcher / Software Developer",
...
export const projects = [
  ...
  },
  {
    ...
    stack: ["HTML 5", "CSS 3", "Vue", "SQLite", "Cron Jobs", "Redis", "Docker"],
    image: "/project-image-temp.png",
    github: "https://github.com/kabironline/Audify-App",
  },
  {
    category: "TomoChat",
    title: "TomoChat",
    description:
      "TomoChat is a customizable instant chat app built for privacy.  This easy-to-use app lets you ditch big data by using your own server. Built with Flutter, TomoChat is not only feature-rich but also visually customizable, making it yours to control.",
    stack: ["Flutter", "Dart", "Firebase"],
    image: "/project-image-temp.png",
    github: "https://github.com/kabironline/tomochat",
  },
];
